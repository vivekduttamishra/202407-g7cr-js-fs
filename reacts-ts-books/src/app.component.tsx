...
import { AuthorManageScreen } from './screens/authors/author-manage.screen';
...
export const App = ()=>{
    const [authors, updateAuthors]=useState<Author[]>(authorList);
            ...
            <div className='screen'>
                <Router>
                  <Routes>
                    ...
                    <Route path="/author/details/:id" element={<AuthorDetailsScreen   />} />
                    
                    <Route path="/author/add" element={<AuthorAddScreen   />} />
                    
                    {/*Make catch all route your last route*/}
